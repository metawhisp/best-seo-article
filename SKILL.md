...
10. Build `research/quality-gate.json` before approval: reader job, direct-answer location, decision criteria, section-to-evidence coverage, information gain, contextual length evidence, and visual/data decision. Run an independent claim verification pass, then editorial, SEO, YMYL when applicable, media, and technical checks. The human editorial rubric must test answer/intent, truth/boundaries, information gain, practical utility, clarity/voice, and journey/conversion; it is not replaceable by a word count or aggregate score. Record machine-verifiable verdicts in bound JSON review records; keep `reviews/editorial.md` as human-readable notes, not the approval itself.
